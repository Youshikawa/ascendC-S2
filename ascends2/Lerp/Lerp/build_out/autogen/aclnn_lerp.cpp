...
[[maybe_unused]] uint32_t NNOPBASE_Lerp = 0U;
} // namespace
    ...
    aclOpExecutor **executor)
{
    ...
    static NnopbaseDfxId tilingId = {0x60000, "aclnnLerpTiling", false};
    void *nnopExecutor;
    static void *executorSpace = NULL;
    const char *opType = "Lerp";
    char inputDesc[] = {1, 1, 1};
    char outputDesc[] = {1};
    char attrDesc[] = {};

    NNOPBASE_ASSERT_NOTNULL_RETVAL(start);
    NNOPBASE_ASSERT_NOTNULL_RETVAL(end);
    ...
    *executor = reinterpret_cast<aclOpExecutor *>(nnopExecutor);
    ...
    NNOPBASE_ASSERT_OK_RETVAL(NnopbaseAddInput(*executor, start, 0));
    NNOPBASE_ASSERT_OK_RETVAL(NnopbaseAddInput(*executor, end, 1));
