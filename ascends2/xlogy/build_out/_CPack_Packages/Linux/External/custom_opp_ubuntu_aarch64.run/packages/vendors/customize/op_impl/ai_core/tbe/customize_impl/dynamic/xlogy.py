...
@tbe_register.register_operator("Xlogy", trans_bool_to_s8=False)
...
def xlogy(x1_in__, x2_in__, y_out_, kernel_name="xlogy", impl_mode=""):
    ...
    origin_func_name = "xlogy"
    ascendc_src_dir_ex = "xlogy"
    ascendc_src_dir = "xlogy"
    ascendc_src_file = "xlogy.cpp"
    src = get_kernel_source(ascendc_src_file, ascendc_src_dir, ascendc_src_dir_ex)

    print("start compile Ascend C operator Xlogy. kernel name is " + kernel_name)
    op_type = "Xlogy"
...
def op_select_format(x1_in__, x2_in__, y_out_, impl_mode=""):
    __inputs__, __outputs__, __attrs__ = _build_args(x1_in__, x2_in__, y_out_)
    result = check_op_cap("op_select_format", "Xlogy", __inputs__, __outputs__, __attrs__)
    return result.decode("utf-8")

def get_op_specific_info(x1_in__, x2_in__, y_out_, impl_mode=""):
    __inputs__, __outputs__, __attrs__ = _build_args(x1_in__, x2_in__, y_out_)
    result = check_op_cap("get_op_specific_info", "Xlogy", __inputs__, __outputs__, __attrs__)
    return result.decode("utf-8")
